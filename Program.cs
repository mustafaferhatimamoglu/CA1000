...
public static class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        {
            response = await GetGreetingAsync(key, prompt) ?? "Merhaba!";
        }
        else
        {
            response = "Merhaba!";
    ...
    private static async Task<string?> GetGreetingAsync(string apiKey, string prompt)
    {
